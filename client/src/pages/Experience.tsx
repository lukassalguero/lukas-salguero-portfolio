...
const experiences = [
  {
    ...
    highlights: [
      "Data ETL & Revenue Monitoring: Extracted data from Databricks using SQL to monitor DCC Visa transactions and calculate real-time revenue, which I then integrated into dashboards that allowed the team to track weekly performance and commercial results, improving the accuracy of our monthly projections",
      "Automation Initiative: I proposed and build an automated incident reporting system that centralized real-time data from internal databases using Power Automate and Excel. This reduced manual reporting time by 30% and enabled the team to identify and respond to ATM issues much faster.",
      "Strategic Analysis: I contributed to the channel strategy by comparing the financial and operational performance of ATMs in different areas of the country, helping the team identify which ATMs generated the highest returns and where investment or reallocation of resources would have the greatest impact.",
      "Cross-functional Collaboration: Coordinated with different teams and Business Specialists to gather and validate daily ATM and POS revenue data. I was responsible for consolidating this information to ensure its accuracy before delivering the final reports to the Treasury department.",
    ],
